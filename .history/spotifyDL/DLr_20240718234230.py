...
label = customtkinter.CTkLabel(master=frame, text ="Enter Link To DownLoad", text_font=("Roboto",24))
label.pack(pady=12, padx=10)

entry1 = customtkinter.CTkEntry(master= frame, placeholder_text="Spotify Link")
entry1.pack(pady=12,padx=10)

button = customtkinter.CTkButton(master=frame,placeholder_text="Download",command = spotify)
button.pack(pady= 12, padx = )
root.mainloop()